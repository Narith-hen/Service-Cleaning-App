        ...
        <div className="max-w-7xl mx-auto px-8 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-4xl font-black mb-6">
              About <span className="text-teal-700">CleaningPro</span>
            </h2>

            <p className="text-gray-600 text-lg mb-4">
              CleaningPro has been delivering professional cleaning services
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <div className="w-6 h-6 bg-teal-700 text-white rounded-full flex items-center justify-center text-xs font-bold">
                  OK
                </div>
            ...
            <button className="mt-8 bg-teal-700 text-white px-8 py-3 rounded-full font-semibold hover:scale-105 transition">
              Learn More
            </button>
          </div>
        </div>
