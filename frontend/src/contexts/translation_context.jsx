...
const adminPhraseTranslations = {
  km: {
    ...
    'Review new booking requests and completed services from one place.': 'ពិនិត្យសំណើកក់ថ្មី និងសេវាកម្មដែលបានបញ្ចប់នៅកន្លែងតែមួយ។',
    'Refresh': 'ធ្វើបច្ចុប្បន្នភាព',
    'Total Alerts': 'ការជូនដំណឹងសរុប',
    'All active notification items for booking activity.': 'ធាតុជូនដំណឹងសកម្មទាំងអស់សម្រាប់សកម្មភាពការកក់។',
    'New Requests': 'សំណើថ្មី',
    'New Request': 'សំណើថ្មី',
    'Fresh customer requests waiting for admin attention.': 'សំណើថ្មីពីអតិថិជនកំពុងរង់ចាំការពិនិត្យពីអ្នកគ្រប់គ្រង។',
    'Completed Jobs': 'ការងារដែលបានបញ្ចប់',
    'Completed': 'បានបញ្ចប់',
    'Bookings that already reached completed status.': 'ការកក់ដែលបានឈានដល់ស្ថានភាពបានបញ្ចប់រួចហើយ។',
    'Unread': 'មិនទាន់អាន',
    'Notifications you have not opened yet.': 'ការជូនដំណឹងដែលអ្នកមិនទាន់បានបើកមើល។',
    'Unable to load notifications right now.': 'មិនអាចផ្ទុកការជូនដំណឹងបាននៅពេលនេះទេ។',
    'You are all caught up on completed jobs and new requests.': 'អ្នកបានពិនិត្យរួចរាល់លើការងារបានបញ្ចប់ និងសំណើថ្មីទាំងអស់។',
    'Booking completed': 'ការកក់បានបញ្ចប់',
    'New booking request': 'សំណើកក់ថ្មី',
    'Booking': 'ការកក់',
